...
export const metadata = {
  title: 'Nuestros Proyectos - Refined LLC',
  description: 'Portafolio de proyectos completados de diseño y construcción.',
}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              Explora nuestro portafolio de proyectos completados con excelencia
            </p>
          </div>
        </div>
      </section>
